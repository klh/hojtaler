...
export CHANNELS HZ BITS DEVICE_NAME BITRATE INITIAL_VOLUME MAX_VOLUME SCRIPT_DIR PROJECT_ROOT CONFIG_DIR GETS_DIR CONFIGS_DIR REAL_USER LOG_FILE LIBRESPOT_HEAD BINARIES_DIR