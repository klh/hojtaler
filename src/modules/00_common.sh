...
export CHANNELS HZ BITS DEVICE_NAME BITRATE VOLUME VOLUME_RANGE SCRIPT_DIR PROJECT_ROOT CONFIG_DIR GETS_DIR CONFIGS_DIR REAL_USER LOG_FILE LIBRESPOT_HEADi